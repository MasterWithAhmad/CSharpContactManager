...
namespace Contact_Management_System {
    ...
    public partial class contact_dbDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactsRow AddContactsRow(string name, string address, string phone, string email, string gender) {
...
namespace Contact_Management_System.contact_dbDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Contacts] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([address] = @Original_address) AND ([phone] = @Original_phone) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([name], [address], [phone], [email], [gender]) VALU" +
                "ES (@name, @address, @phone, @email, @gender);\r\nSELECT id, name, address, phone," +
                " email, gender FROM Contacts WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contacts] SET [name] = @name, [address] = @address, [phone] = @phone, [email] = @email, [gender] = @gender WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([address] = @Original_address) AND ([phone] = @Original_phone) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)));
SELECT id, name, address, phone, email, gender FROM Contacts WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Contact_Management_System.Properties.Settings.Default.contact_dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, phone, email, gender FROM dbo.Contacts";
        ...
        public virtual int Fill(contact_dbDataSet.ContactsDataTable dataTable) {
        ...
        public virtual contact_dbDataSet.ContactsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            contact_dbDataSet.ContactsDataTable dataTable = new contact_dbDataSet.ContactsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(contact_dbDataSet.ContactsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_address, string Original_phone, string Original_email, string Original_gender) {
        ...
        public virtual int Insert(string name, string address, string phone, string email, string gender) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string address, string phone, string email, string gender, int Original_id, string Original_name, string Original_address, string Original_phone, string Original_email, string Original_gender, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string phone, string email, string gender, int Original_id, string Original_name, string Original_address, string Original_phone, string Original_email, string Original_gender) {
            return this.Update(name, address, phone, email, gender, Original_id, Original_name, Original_address, Original_phone, Original_email, Original_gender, Original_id);
        }
    }
